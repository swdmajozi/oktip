...
<br>  <br> <br>     
  ...
  <form  id="payform" action="https://www.payfast.co.za/eng/process" method="post" onsubmit="return checkForm(this);">
    ...
    <input id="notify_url" name="notify_url" value="http://dev.icswebserver.co.za/payfast/itn" type="hidden">
    ...
    <?php  if($cus->subscription_type == 1) {?>
 ...
 <input id="amount" name="amount" value="<?php echo  $cus->productAmount;?>" type="hidden">
