             ...
             <h1 class="page-header">
                           <small>Admin Outstanding Payments</small>
                        </h1>      
...
<?php foreach ($help as $key) {?>
    ...
    <td> <a href="<?php echo base_url();?>gethelp/block/<?php echo $key['ref'];?>/<?php echo $key['receiver'];?>/<?php echo $key['senderid'];?>">Cancel And Block </a></td>
