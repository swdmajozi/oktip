...
<div id="pageone" data-role="main" class="ui-content">
 ...
 <td><a href="<?php echo base_url();?>/providehelp/confirmpaymentrecived/id/<?php echo $key['id'];?>/userid/<?php echo $key['userfromid'];?>/<?php echo $key['ref_no'];?>/<?php echo $key['amount'];?>/<?php echo $key['period'];?>" class="btn btn-primary">Confirm</a></td>
