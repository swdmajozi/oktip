...
class HtmltoPDF extends CI_Controller {
	...
	{
		$data['customer_data'] = $this->htmltopdf_model->GetDetails();
	...
	public function pdfdetails()
	{
		...
		{
			$customer_id = $this->uri->segment(3);
			$html_content = '<img align="center" src="http://icswebserver.co.za/siyandamadjozi//assets/images/logobig.png" class="img-circle image-responsive logo" alt="ICS Logo" style="width: 50% !important;" >';
