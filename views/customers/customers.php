...
<div class="form-group has-feedback col-md-6">
        ...
        <p>Please Customer Salary Bracket</p>      
<select name="salary" id="salary"  class=" form-control-feedback=" style="width: 100% !important; padding:8px;">
<option value="0-4000">Below R4000</option>
<option value="0-4000"">R4000 - R7000</option>
<option value="0-4000"">R7000 Or More</option>
</select>
