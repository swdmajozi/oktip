...
<div class="row"><h4>Time Now: <?php echo date('H:i');?>   --------     Bidding Times: <span style="color: red;">09:30 AM</span>  and <span style="color: red;">18:30 PM</span> </h4>
...
//if (($date > '00:30' && $date < '23:30') || ($date > '16:00' && $date < '00:30') ) {
